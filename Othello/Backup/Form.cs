...
namespace Othello {
    public partial class Othello : Form {
	  ...
	  private readonly Size buttonSize = new Size(100, 100);	    //The size of each button.
	  private Dictionary<Players, List<Square>> squaresOf = new Dictionary<Players, List<Square>>( );	//Contians three lists, one of which contains all empty squares, one of which contains all black squares, and one of which contains all white squares.
